...
/**
 * Geração do boleto em arquivos. Essa é uma classe utilitária, dessa maneira você não precisa trabalhar com InputStream, byte[], etc.
 * 
 * Basta passar um Boleto para o construtor e usar o método adequado para gerar um PDF, PNG, etc e grava-lo como o arquivo desejado.
 * 
 * 
 */
public class GeradorDeBoleto {
      ...
      * 
      * @param template
      * o template (.jasper) a ser usado (obrigatório).
      * @param parametros
      * parametros extras para o relatório( opcional).
      * @param boletos
      * boletos.
      */
      ...
      * 
      * @param arquivo
      * caminho para o aquivo onde será gravado o PNG.
      */
