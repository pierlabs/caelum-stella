...
public class Boleto implements Serializable {
     ...
     /**
      * @return novo Boleto com valores default de especieMoeda R$, código de espécie moeda 9 (real), aceite false e espécie DV
      */
     public static Boleto novoBoleto() {

          return new Boleto().comEspecieMoeda("R$").comCodigoEspecieMoeda(9).comRegistrado(true).comAceite(false).comEspecieDocumento("DV");
     }
     ...
     /**
      * @param datas
      * que serão associadas ao boleto
      * @return este boleto
      */
     ...
     /**
      * @param valor
      * em double que após ser convertido pra String será associado ao boleto @see Boleto#comValorBoleto(String)
      * 
      * @return this
      */
     ...
     /**
      * @param valor
      * String que é convertido para BigDecimal com o Locale da JVM @see Boleto#comValorBoleto(BigDecimal)
      * @return this
      */
     ...
     /**
      * @param instrucoes
      * que serão associadas ao boleto (limite de 5)
      * @throws IllegalArgumentException
      * caso tenha mais de 5 instruções
      * @return este boleto
      */
     ...
     /**
      * @param descricoes
      * que serão asociadas ao boleto (limite de 5) <br>
      * Note que esse campo não aparece no boleto gerado em PNG
      * @throws IllegalArgumentException
      * caso tenha mais de 5 descrições
      * @return este boleto
      */
     ...
     /**
      * @param descricao
      * que será adicionada à lista de descricoes do boleto <br>
      * Note que esse campo não aparece no boleto gerado em PNG
      * @throws IllegalArgumentException
      * caso a descrição seja nula
      * @throws UnsupportedOperationException
      * caso a lista de descrições tenha 5 descrições
      * @return este boleto
      */
      ...
      * que serão associados ao boleto (limite de 2 locais)
      * @throws IllegalArgumentException
      * tiver mais de 2 locais de pagamento
      * @return este boleto
      */
     ...
     public BigDecimal getValorCobrado() {
          ...
          return valorBoleto.subtract(valorDescontos).subtract(valorDeducoes).add(valorMulta).add(valorAcrescimos);
     }
     ...
     /**
      * @return valor setado para registro do boleto, por default o valor é TRUE
      */
     ...
     /**
      * @param registrado
      * boolean indicando se o boleto será registrado ou não
      * @return este boleto
      */
